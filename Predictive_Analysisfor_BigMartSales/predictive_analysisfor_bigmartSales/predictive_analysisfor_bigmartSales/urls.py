"""predictive_analysisfor_bigmartSales URL Configuration
...
from predictive_analysisfor_bigmartSales import settings
...
urlpatterns = [
    ...
    url(r'View_Remote_Users/$', serviceprovider.View_Remote_Users,
    ...
    url(r'^likeschart/(?P<like_chart>\w+)',
        serviceprovider.likeschart, name="likeschart"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Find_Big_Mart_Sale_Predicted_Details/$',
        serviceprovider.Find_Big_Mart_Sale_Predicted_Details, name="Find_Big_Mart_Sale_Predicted_Details"),
